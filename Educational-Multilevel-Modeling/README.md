...
## File Inventory
* `Educational-Multilevel-Modeling.ipynb`: Documented Jupyter notebook containing data preprocessing, missing data analysis, iterative model building, parameter estimations, and residual diagnostics.
