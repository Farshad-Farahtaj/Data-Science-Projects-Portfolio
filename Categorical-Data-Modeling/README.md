...
Welcome to my repository for Categorical-Data-Modeling 1 of the Advanced Statistical Learning and Modeling (Module B) course. 
...
* `Categorical-Data-Modeling_analysis.ipynb`: The main Jupyter Notebook containing all the Python code, statistical tests, model diagnostics, and visualizations.
* `COMPLETE_SUMMARY.md`: A plain-English breakdown of the statistical findings and methodologies.
* `Instructions.pdf`: The official Categorical-Data-Modeling guidelines.
